...
#include <dpn/protocol/dpn_virtual_operations.hpp>
...
/*namespace fc {
    void to_variant( const dpn::protocol::operation& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  dpn::protocol::operation& vo );
}*/

DPN_DECLARE_OPERATION_TYPE( dpn::protocol::operation )
FC_REFLECT_TYPENAME( dpn::protocol::operation )
